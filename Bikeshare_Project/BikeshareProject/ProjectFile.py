        ...
        if i < num_rows:
            if raw_data.lower() == 'yes':
                if i+5 < num_rows:
                    ...
                    print (data.iloc[i:num_rows])
                    i = num_rows
            else:
                break
        else:
            break
        raw_data = input('Do you want to further see raw data: Enter yes or no.\n')
...
def user_stats(df):
    ...
    if 'Gender' in list(df): 
        ...
        print ("This city doesn't contain gender")
    ...
    if 'Birth Year' in list(df):
        ...
        print ("This city doesn't contain birth year")
